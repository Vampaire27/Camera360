package com.wwc2.camera360.util;
...
public class CameraUtil {
    ...
    public static int CAMERA_MODULE_STOP = 1;
    public static int CAMERA_MODULE_RUNNING = 1 << 1;
    public static int CAMERA_STATE_OPENED = 1 << 2;
    public static int CAMERA_STATE_UI_READY = 1 << 3;
    public static int CAMERA_STATE_START_RECORD = 1 << 4;
    public static int CAMERA_STATE_PAUSE_RECORD = 1 << 5;
